...
Hoofdstuk~\ref{ch:performantie} Performantie

Hoofdstuk~\ref{ch:views} Creatie van views:

Hoofdstuk~\ref{ch:asynchroon} Asynchroon werken:

Hoofdstuk~\ref{ch:api} Gebruik van API’s:

Hoofdstuk~\ref{ch:security} Security:

Hoofdstuk~\ref{ch:complexiteit} Beschikbare libraries en code complexiteit:

Hoofdstuk~\ref{ch:tooling} Tooling:

...
Het volgende onderzochte criterium was het uit voeren van asynchrone taken binnen elk framework. Hierbij werden de verschillende manieren van asynchroon werken aangehaald voor elk framework. De voor- en nadelen van deze asynchrone ontwikkelmanieren werden opgesomd, uitgelegd, onderzocht en vergeleken op basis van hun voor- en nadelen.

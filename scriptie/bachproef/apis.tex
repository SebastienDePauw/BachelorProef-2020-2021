...
Wanneer een app gebruik wilt maken van data die niet door de eindgebruiker is ingegeven moet een netwerkconnectie tot stand worden gebracht. Daarom is het voor elke nieuwe app ontwikkelaar belangrijk om op de hoogte te zijn van de werking hiervan.
...
Eén van de bekendere en gebruiksvriendelijkste API’s op het web is de PokéApi. Deze RESTful API, die informatie biedt omtrent allerlei Pokémon, is goed ondersteunt en duidelijk gedocumenteerd. Deze documentatie is te lezen op een overzichtelijke site.

...
\section{Conclusie}
Zoals in vorige hoofdstuk \ref{ch:asynchroon} ook het geval was, is ook hier Android veel rijker aan keuzes. 
De tijd gespendeerd aan de uitwerking van elk van deze \right) 
 geconcludeerd worden dat de libraries voor API calls minder gebruiksvriendelijk zijn. Flutter daarentegen biedt een simpele, overzichtelijke, goed gedocumenteerde manier voor het uitvoeren van API calls.
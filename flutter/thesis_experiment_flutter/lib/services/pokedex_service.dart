...
import 'package:thesis_experiment/models/pokedex.dart';
import 'package:thesis_experiment/models/pokemon.dart';
...
class PokedexService {
  static getPokedex(id) async {
    ...
    try {
      ...
      final response = await http.post(Uri(path: url), body: {'regionId': id.toString()});
  ...
  static getPokemon({required String name}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    try {
      ...
      final response = await http.post(Uri(path: url), body: {'pokemon': name});
  ...
  static Future<List<List<Pokemon>>?> getEvolutionChain({required int chainId}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    try {
      ...
      final response =
      await http.post(Uri(path: url), body: {'chainId': chainId.toString()});
  ...
  static getPokemonVariations({
    required String pokemonVariationName,
    required String pokemonSpeciesName,
  }) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    try {
      ...
      final response = await http.post(Uri(path: url), body: {
